...
<head>
    ...
    <link rel="stylesheet" href="<?= assets('public/jalalidatepicker/persian-datepicker.min.css') ?>" type="text/css">
    ...
    <div class="container-fluid">
        <div class="row">
            <nav class="col-md-2 d-none d-md-block pt-3 bg-sidebar sidebar px-0">
                ...
                <a class="text-decoration-none d-block py-1 px-2 mt-1" href="<?= url('admin/comment') ?>"><i class="fas fa-comments"></i>
                    Comment</a>
                ...
                <a class="text-decoration-none d-block py-1 px-2 mt-1" href="<?= url('admin/setting') ?>"><i class=" fas fa-tools"></i> Web
                    Setting</a>
            </nav>
