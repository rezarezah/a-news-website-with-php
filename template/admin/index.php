            ...
            <table class="table table-striped table-sm">
                ...
                <tbody>
                    <?php foreach ($mostViewedPosts as $mostViewedPost) { ?>
                        <tr>
                            <td>
                                <?php echo  $mostViewedPost['id'] ?>
                            </td>
                            <td>
                                <?php echo $mostViewedPost['title'] ?>

                            </td>
                            <td><span class="badge badge-secondary">
                                    <?php echo $mostViewedPost['view'] ?>
                                </span></td>
                        </tr>
                    <?php } ?>
            ...
            <table class="table table-striped table-sm">
                ...
                <tbody>
                    <?php foreach ($mostCommentedPosts as $mostCommentedPost) { ?>
                        <tr>
                            <td>
                                <?php echo $mostCommentedPost['id'] ?>

                            </td>
                            <td>
                                <?php echo $mostCommentedPost['title'] ?>

                            </td>
                            <td><span class="badge badge-success">
                                    <?php echo $mostCommentedPost['comment_count'] ?>
                                </span></td>
                        </tr>
                    <?php } ?>
