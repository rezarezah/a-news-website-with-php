            ...
            <?php if (isset($topSelectedPosts[0])) { ?>
                <div class="editors-pick-post">
                    ...
                    <div class="details">
                        ...
                        <ul class="meta">
                            <li><a href="#"><span class="lnr lnr-user"></span><?= $topSelectedPosts[0]['username'] ?></a>
                            </li>
        ...
        <?php if (!empty($sidebarBanner)) { ?>
            <div class="single-sidebar-widget ads-widget">
                <a href="<?= $sidebarBanner['url'] ?>">
                    <img class="img-fluid" src="<?= assets($sidebarBanner['image']) ?>" alt="">
        ...
        <div class="single-sidebar-widget most-popular-widget">
            ...
            <?php foreach ($mostCommentPosts as $mostCommentPost) { ?>
                <div class="single-list flex-row d-flex">
                    <div class="thumb">
                        <img src="<?= assets($mostCommentPost['image']) ?>" alt="" width="120" height="80">
                    </div>
                    <div class="details">
                        <a href="image-post.html">
